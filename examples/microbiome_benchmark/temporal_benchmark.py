...
-----
  ...
  python -m examples.microbiome_benchmark.temporal_benchmark

  # with JEPA predictor:
  python -m examples.microbiome_benchmark.temporal_benchmark --ckpt artifacts/ckpt/microbiome_jepa.pt

  # larger sweep:
  python -m examples.microbiome_benchmark.temporal_benchmark --n_subjects 40 --T 60 --seeds 0 1 2

  # save results:
  python -m examples.microbiome_benchmark.temporal_benchmark --out results/temporal_benchmark.json
"""
